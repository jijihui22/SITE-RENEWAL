<?php
  ...
  $title = '쿠폰 목록';
	...
	$coup_css = '<link rel="stylesheet" href="/attention_renewal/admin/css/coup.css">';
	$coup_ok_css =	'<link rel="stylesheet" href="/attention_renewal/admin/css/coup_ok.css">';
...
<script>
	...
	change: function( event, data ) {
		...
		location.href=`/attention_renewal/admin/coupon/coupon_list.php?status=${selected_value}`;
	}
});
