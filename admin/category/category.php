<?php
  $category_css = '<link rel="stylesheet" href="/attention_renewal/admin/css/category.css">';
...
<script>
  ...
  $(".cate_close button").click(function(e){
    e.preventDefault();
    location.href = '/attention_renewal/admin/class/class_list.php';
  });
...
<script src="/attention_renewal/admin/js/category.js"></script>   
<?php
