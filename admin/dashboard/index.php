...
$index_css = '<link rel="stylesheet" href="/attention_renewal/admin/css/index.css">';
            ...
            <div class="pop_class_list d-flex flex-column">
                <?php foreach ($class as $item) { ?>
                    <div class="top_class d-flex justify-content-between align-items-center">
                        <img src="/attention_renewal/admin/img/dashboard/<?= $item->name ?>.png" alt="<?= $item->name ?>">
...
<script src="/attention_renewal/admin/js/index.js"></script>
<script>
    $('.dash_menu').css({
