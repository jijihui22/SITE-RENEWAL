                  ...
                  <td class="class_video">
                    <div class="video_wrap">
                      <div class="video_address">
                        <input type="text" class="form-control class_lform_wd white_back" placeholder="동영상 주소를 입력하세요" name="video[]" required>
                      </div>
                      <button type="button" id="video_add"><i class="bi bi-plus-circle icon_gray"></i></button>
                    </div>
                    <a href="/attention_renewal/admin/class/url_detail.php" id="video_method">강좌 업로드 가이드</a>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    <div class="drop form-control d-flex justify-content-center align-items-center gray" id="drag_drop">
                      <span class="text3"><i class="bi bi-upload icon_gray"></i>이미지를 Drag & Drop 하세요.</span>
