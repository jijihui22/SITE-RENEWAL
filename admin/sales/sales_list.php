<?php
  $sales_css = '<link rel="stylesheet" href="/attention_renewal/admin/css/sales.css">';
  $title = '매출 관리 - Code Rabbit';
  require_once $_SERVER['DOCUMENT_ROOT'].'/attention_renewal/admin/inc/header.php';
  require_once $_SERVER['DOCUMENT_ROOT'].'/attention_renewal/admin/inc/admin_check.php';
  ...
  require_once $_SERVER['DOCUMENT_ROOT'].'/attention_renewal/admin/inc/pagenation.php';
...
<script src="/attention_renewal/admin/js/jquery.number.min.js"></script>
<script>
  $('.number').number(true);
