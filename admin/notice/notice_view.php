<?php
  ...
  $notice_css = '<link rel="stylesheet" href="/attention_renewal/admin/css/notice.css">';
...
<div class="notice_view common_pd">
  ...
  <div class="mt-4 text-end">
    <a href="/attention_renewal/admin/notice/notice_modify.php?idx=<?= $rs2 -> idx; ?>" class="btn btn-primary mx-4">글 수정</a>
