<?php
$login_css = '<link rel="stylesheet" href="/attention_renewal/user/css/login.css">';
require_once $_SERVER['DOCUMENT_ROOT'].'/attention_renewal/user/inc/header.php';

if(isset($_SESSION['UID'])){
  echo "<script>alert('이미 로그인 하셨습니다');
    location.href = '/attention_renewal/user/index.php';</script>";
}
?>
      ...
      <div class="login">
        ...
        <div class="login_link d-flex justify-content-between">
          <div class="login_find d-flex justify-content-between">
            <a href="/attention_renewal/user/member/find_id.php">아이디 찾기</a>
            <a href="/attention_renewal/user/member/find_pw.php" class="login_link_pw">비밀번호 찾기</a>
          </div>
          <a href="/attention_renewal/user/member/signup.php">회원가입</a>
        </div>
