...
<aside id="recent" class="radius_medium position-fixed text-center d-flex flex-wrap px-2 py-3 gap-3 white_back z-2">
  ...
  <img src="/attention_renewal/user/img/main/new_7.png" alt="썸네일 이미지">
  <img src="/attention_renewal/user/img/main/new_7.png" alt="썸네일 이미지">
</aside>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="radius_medium box_shadow p-3 d-flex align-items-start mt-4">
          <a href="" class="d-flex">
            <img src="/attention_renewal/user/img/main/new_8.png" alt="썸네일 이미지" class="col-4">
            <div class="ms-4 mt-2">
...
<footer class="white dark_blue_back">
    <div class="container_cr d-flex justify-content-between">
      <div class="d-flex align-items-center">
        <img src="/attention_renewal/user/img/main/footer_coderabbit_logo.svg" alt="코드래빗 로고">
      </div>
      <address>
        <p><a href="#">코드래빗 소개</a><a href="/attention_renewal/user/product_whole_list.php">코드래빗 강좌리스트</a><a href="/attention_renewal/user/notice.php">코드래빗 공지사항</a><a href="#">개인정보처리방침</a><a href="#">이용약관</a></p>
        <ul>
      ...
      <ul class="footer_sns d-flex">
        <li><a href="#"><img src="/attention_renewal/user/img/main/footer_kakaotalk_logo.svg" alt="kakaotalk logo"></a></li>
        <li><a href="#"><img src="/attention_renewal/user/img/main/footer_band_logo.svg" alt="band logo"></a></li>
        <li><a href="#"><img src="/attention_renewal/user/img/main/footer_instagram_logo.svg" alt="instagram logo"></a></li>
        <li><a href="#"><img src="/attention_renewal/user/img/main/footer_facebook_logo.svg" alt="facebook logo"></a></li>
      </ul>
    </div>
  </footer>
  <script>
