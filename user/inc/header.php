...
<head>
  ...
  <link rel="stylesheet" href="/attention_renewal/user/css/common.css">
  <link rel="stylesheet" href="/attention_renewal/user/css/footer.css">
...
<body>
  <header>
    <nav class="d-flex justify-content-between align-items-center container_cr">
      <h1>
        <a href="/attention_renewal/user/index.php">
          <img src="/attention_renewal/user/img/main/coderabbit_logo.svg" alt="코드래빗 로고">
        </a>
      </h1>
      <ul class="d-flex align-items-center menu-list text1 fw-bold">
        <li><a href="#">ABOUT</a></li>
        <li><a href="/attention_renewal/user/product_whole_list.php">강의</a></li>
        <li><a href="/attention_renewal/user/notice.php">공지사항</a></li>
      </ul>
      ...
      <div class="d-flex justify-content-between login-ok-btn gap">
        <a href="/attention_renewal/user/cart/cart.php" class="d-flex align-items-center">
              ...
              <div class="login_box d-flex flex-column align-items-center">
                <div class="login_top d-flex flex-column align-items-center">
                  ...
                  <div class="thumbnail d-flex align-items-center">
                    <img src="/attention_renewal/user/img/main/piskel_rabbit.png" alt="프로필">
                  </div>
                </div>
                <div class="login_icon_box d-flex justify-content-between">
                  <a href="/attention_renewal/user/coupon.php" class="col"><i class="bi bi-ticket-perforated"></i><span>쿠폰함</span></a>
                  <a href="/attention_renewal/user/my_class.php" class="col"><i class="bi bi-mortarboard"></i><span>내 강의실</span></a>
                </div>
              </div>
              <div class="login_bot text-end icon_red mt-3 text5">
                <a href="/attention_renewal/user/logout.php">로그아웃</a>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="d-flex justify-content-between login-btn">
        <a href="/attention_renewal/user/login.php" class="btn btn-outline-primary">로그인</a>
        <a href="/attention_renewal/user/member/signup.php" class="btn btn-dark-blue icon_red_baisc">회원가입</a>
      </div>
      <!-- /로그인 전 -->
