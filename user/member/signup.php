...
?>
<link rel="stylesheet" href="/attention_renewal/user/css/signup.css">
<div class="container">
    ...
    <div class="mb-3">
      ...
      <div class="text-center d-flex flex-column">
        ...
        <div class="d-flex justify-content-between sns">
          <img src="/attention_renewal/user/img/kakaotalk.svg" alt="">
          <img src="/attention_renewal/user/img/band.svg" alt="">
          <img src="/attention_renewal/user/img/instagram.svg" alt="">
          <img src="/attention_renewal/user/img/facebook.svg" alt="">
        </div>
      </div>
    </div>
  </form>
...
<?php
include_once $_SERVER['DOCUMENT_ROOT'].'/attention_renewal/user/inc/footer.php';
?>