...
<link rel="stylesheet" href="/attention_renewal/user/css/main.css">
...
<main>
  ...
  <section class="notice main_mg_t blue_Gray_back">
    <div class="container_cr d-flex align-items-center">
      ...
      <a href="/attention_renewal/user/notice.php" class="col-1 text-center icon_mint">전체보기 +</a>
    </div>
  </section>
</main>

<script src="https://cdn.jsdelivr.net/npm/swiper@10/swiper-bundle.min.js"></script>
<script src="/attention_renewal/user/js/main.js"></script>
<?php
